    ...
    func getParams(parameters: [String: String]) -> [String: String] {
        ...
        case .source:
            return [ //find more info at https://newsapi.org/docs/endpoints/sources
                kCATEGORY: parameters[kCATEGORY] ?? "general", //either: business, entertainment, general, health, science, sports, technology
        ...
        case .articles:
            return [ //find more info at https://newsapi.org/docs/endpoints/everything
                ...
                kPAGESIZE: parameters[kPAGESIZE] ?? "2", //(Int) 20 default and 100 is max
